...
public class Main {
    public static void main(String[] args) {
        ...
        pieces.add(new King(new Coordinate(4, 0), false, t,false));
        ...
        for (int y = 0; y < 8; y++) {
            pieces.add(new Pawn(new Coordinate(y, 1), false, t, false));
        }
        for (int y = 0; y < 8; y++) {
            pieces.add(new Pawn(new Coordinate(y, 6), true, t, false));
        }
        ...
        pieces.add(new King(new Coordinate(4, 7), true, t,false));
